                ...
                <form method="post"  action="edit_proses.php" class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" value="<?= $row2['nama_staff']; ?>" name="nama_staff">
                            </div>
                        </div>
                        <div class="form-group">
                        <label for="bidang_bagian" class=" col-sm-3 control-label">Bidang bagian</label>
                            <div class="col-sm-4">
                            <select id="bidang_bagian" required="isikan dulu" class="form-control" name="bidang_bagian">
