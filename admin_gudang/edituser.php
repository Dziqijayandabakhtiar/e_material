                ...
                <form method="post"  action="edituproses.php" class="form-horizontal">
                    <div class="box-body">
                     <div class="row">
                        ...
                        <input type="hidden" name="id" value="<?= $row2['id_user']; ?>">
                        <div class="form-group ">
                            <label for="bidang_bagian" class="col-sm-offset-1 col-sm-3 control-label">Bidang Bagian</label>
                            <div class="col-sm-4">
                                <input type="text"  required value="<?= $row2['bidang_bagian']; ?>" class="form-control" name="bidang_bagian">
                            </div>
                        </div>
