  ...
  <table class="tabel2">
    <thead>
      <tr>
        ...
        <td style="text-align: center; "><b>Bidang bagian</b></td>
    ...
    <tbody>
      <?php
       ...
       $query = mysqli_query($koneksi, "SELECT pengeluaran.kode_brg, nama_staff, bidang_bagian, nama_brg, jumlah, satuan, tgl_keluar FROM pengeluaran INNER JOIN stokbarang ON pengeluaran.kode_brg = stokbarang.kode_brg  "); 
      $i   = 1;
      ...
      <tr>
        ...
        <td style="text-align: center; width=70px;"><?php echo $data['nama_staff']; ?></td>    
        <td style="text-align: center; width=70px;"><?php echo $data['bidang_bagian']; ?></td>    
