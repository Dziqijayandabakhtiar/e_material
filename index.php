...
<head>
	<meta charset="utf-8">
	<title>Aplikasi Permintaan&pengeluaran Bpbd</title>
	<!-- Icon  -->
...
<body class="hold-transition login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
      	<h3 class="text-center">Aplikasi Permintaan Barang Habis Pakai/Material BPBD Prov.Jateng</h3>
      	<img src="gambar/bpbd.JPG" style="width: 140px; height: 110px;">        
        <form method="post">
          ...
          <div class="form-group">
          	<div class="input-group col-md-7">          	
	            ...
	            <select class="form-control" name="level" required>            	
	            	...
	            	<option value="unit_pelayanan">karyawan/staff</option>
		  ...
		  <div class="row">
            <div class="col-xs-12">
		  <a href="tambahuser.php?p=user" class="small-box-footer pull-right">registrasi akun! <i class="fa fa-arrow-circle-right"></i></a>
        </div>
		</form>
